...
import sty from "./PlasmicButton.module.css"; // plasmic-import: HHZYSLp4mTA/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: mwceYptHL9E/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: HfMjhmTg3Du/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bl1Mv)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__fuc4P)}
                role={"img"}
              />
            ),
